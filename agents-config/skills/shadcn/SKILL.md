---
name: shadcn
description: Manage shadcn/ui components, registries, presets, and projects. Use for shadcn init, components.json, --preset codes, component docs, styling, debugging, or composing UI.
