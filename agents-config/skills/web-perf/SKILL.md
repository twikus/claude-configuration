---
name: web-perf
description: Audit and optimize web performance with Chrome DevTools MCP. Use for Core Web Vitals, Lighthouse scores, page speed, render blockers, network chains, layout shifts, caching, or accessibility gaps.
---
