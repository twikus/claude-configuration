...
description: Write and review Cloudflare Workers code against current best practices. Use for Workers, wrangler.jsonc, bindings, secrets, streaming, global state, observability, or anti-pattern checks.
---
