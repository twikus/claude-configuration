...
- `{phase_2_challenges}` - Challenges and updated beliefs from Phase 2
</available_state>
...
Review `{phase_1_discoveries}` and `{phase_2_challenges}` to ground the analysis:
...
- All 5 perspectives genuinely explored
- Each lens given equal serious consideration
...
- Uncomfortable perspectives not skipped
</success_metrics>
