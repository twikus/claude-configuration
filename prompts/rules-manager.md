...
- **Examples**: [agents-config/skills/rules-manager/references/examples.md](../agents-config/skills/rules-manager/references/examples.md) - Sample rule files (changelog, testing, deployment)
- **AGENTS.md vs CLAUDE.md**: [agents-config/skills/rules-manager/references/agents-vs-claude.md](../agents-config/skills/rules-manager/references/agents-vs-claude.md) - When to use which format
  </reference_guides>
