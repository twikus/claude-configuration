...
- Claude Code → see [agents-config/skills/skill-manager/references/claude-code.md](../agents-config/skills/skill-manager/references/claude-code.md)
- Codex      → see [agents-config/skills/skill-manager/references/codex.md](../agents-config/skills/skill-manager/references/codex.md)
- Cursor     → see [agents-config/skills/skill-manager/references/cursor.md](../agents-config/skills/skill-manager/references/cursor.md)
